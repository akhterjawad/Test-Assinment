...
import { FaArrowRight, FaArrowDown, FaInstagramSquare, FaFacebook, FaLinkedin, FaUserFriends } from "react-icons/fa";
import { FaSquareXTwitter } from "react-icons/fa6"; // Import as named export
            ...
            <div className='container mx-auto p-4'>
                ...
                <div className='flex justify-between mt-[140px] items-center flex-wrap'>
                    <div className='flex flex-col gap-10 slide-top'>
                        <h1 className='sm:text-[65px] text-[32px] font-bold'>
                            Largest <span className='text-[#388FCB]'>Wholesalers</span> <br />
                            of <span className='text-[#388FCB]'>Mobiles Phones</span>
                        </h1>
                        <p className='text-[18px]'>
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Alias <br />
                            maiores harum eligendi, quibusdam impedit rerum?
                        </p>
                        <h1 className='text-[20px] flex items-center gap-2 text-[#388FCB]'>
                            Learn More <FaArrowRight className='mt-1 hover:text-[25px] hover:cursor-pointer' />
                        </h1>
                        <div className='flex gap-4 flex-wrap'>
                            ...
                            <div className='flex gap-2'>
                                <button className='w-[120px] h-[48px] rounded-full bg-green-500 text-white hover:bg-white hover:border hover:border-green-600 hover:text-green-500 flex gap-2 justify-center items-center text-[14px]'>
                                    Subscribe <FaArrowRight />
                                </button>
                                <button className='w-[120px] h-[48px] rounded-full bg-[#388FCB] text-white hover:bg-white hover:border hover:border-[#388FCB] hover:text-[#388FCB] flex gap-2 justify-center items-center text-[14px]'>
                                    <FaArrowDown /> Stock list
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div className='flex items-center gap-8 flex-wrap sm:justify-start justify-center'>
                    ...
                    <div className='flex gap-2 items-center'>
                        ...
                        <p className='text-[18px] font-semibold bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text'>
                            400k People Register
                        </p>
                    </div>
                </div>
